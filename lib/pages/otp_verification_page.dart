              ...
              children: [
                ...
                Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Center(child: Image.asset("assets/images/app_logo_1.png",height: 100,width: 150)),
                      SizedBox(height: 30),
                      Text(
                      ...
                      Padding(
                        ...
                        child: Text(
                            style: TextStyle(color: CustomColors.textColor,fontSize: 16,fontWeight: FontWeight.w400),"OTP has been sent to you on your mobilenumber, please enter it below ${widget.otp}"
                        ),
                      ),
                      Center(
                        child: Padding(
